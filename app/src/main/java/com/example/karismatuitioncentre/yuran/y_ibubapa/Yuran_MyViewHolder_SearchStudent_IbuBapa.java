...
public class Yuran_MyViewHolder_SearchStudent_IbuBapa extends RecyclerView.ViewHolder {
    TextView nama,kp,email;
    View v;

    public Yuran_MyViewHolder_SearchStudent_IbuBapa(@NonNull View itemView) {
        super(itemView);
