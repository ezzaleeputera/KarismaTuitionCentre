...
public class Prestasi_MyViewHolder_ViewRemarks_IbuBapa extends RecyclerView.ViewHolder {
    TextView tvTitleRemarks,tvRemarks,tvtarikh;

    View v;

    public Prestasi_MyViewHolder_ViewRemarks_IbuBapa(@NonNull View itemView) {
        super(itemView);
