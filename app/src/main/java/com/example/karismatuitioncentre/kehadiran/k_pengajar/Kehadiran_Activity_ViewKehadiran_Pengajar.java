...
public class Kehadiran_Activity_ViewKehadiran_Pengajar extends AppCompatActivity {


    RecyclerView recyclerView;
    FirebaseRecyclerOptions<Kehadiran_Model> options;
    FirebaseRecyclerAdapter<Kehadiran_Model, Kehadiran_MyViewHolder_ViewKehadiran_Pengajar> adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new FirebaseRecyclerAdapter<Kehadiran_Model, Kehadiran_MyViewHolder_ViewKehadiran_Pengajar>(options) {
            @Override
            protected void onBindViewHolder(@NonNull Kehadiran_MyViewHolder_ViewKehadiran_Pengajar holder, int position, @NonNull Kehadiran_Model model) {
            ...
            @NonNull
            @Override
            public Kehadiran_MyViewHolder_ViewKehadiran_Pengajar onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow_kehadiran_sejarahkehadiran_pelajar,parent,false);


                return new Kehadiran_MyViewHolder_ViewKehadiran_Pengajar(v);
            }
        };
