...
public class Kehadiran_Activity_ViewKehadiran_Pelajar extends AppCompatActivity {


    RecyclerView recyclerView;
    FirebaseRecyclerOptions<Kehadiran_Model> options;
    FirebaseRecyclerAdapter<Kehadiran_Model, Kehadiran_MyViewHolder_ViewKehadiran_Pelajar> adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options= new FirebaseRecyclerOptions.Builder<Kehadiran_Model>()
                .setQuery(FirebaseDatabase.getInstance().getReference()
                        .child("Kehadiran_List").orderByChild("userid").equalTo(uid), Kehadiran_Model.class)
                .build();


        adapter=new FirebaseRecyclerAdapter<Kehadiran_Model, Kehadiran_MyViewHolder_ViewKehadiran_Pelajar>(options) {
            @Override
            protected void onBindViewHolder(@NonNull Kehadiran_MyViewHolder_ViewKehadiran_Pelajar holder, int position, @NonNull Kehadiran_Model model) {
            ...
            @NonNull
            @Override
            public Kehadiran_MyViewHolder_ViewKehadiran_Pelajar onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow_kehadiran_sejarahkehadiran_pelajar,parent,false);


                return new Kehadiran_MyViewHolder_ViewKehadiran_Pelajar(v);
            }
        };
