...
public class Kehadiran_MyViewHolder_ViewKehadiran_Pengajar extends RecyclerView.ViewHolder {
    TextView subjekHist,pengajarHist,masaSHist,masaEHist,tarikhSHist;
    View v;

    public Kehadiran_MyViewHolder_ViewKehadiran_Pengajar(@NonNull View itemView) {
        super(itemView);
