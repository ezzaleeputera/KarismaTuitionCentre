...
public class Isnin_Activity_Pelajar_IbuBapa extends AppCompatActivity {

    Isnin_Adapter_Pelajar_IbuBapa adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter= new Isnin_Adapter_Pelajar_IbuBapa(options);
