...
public class Yuran_ViewActivity_IbuBapa extends AppCompatActivity {
    TextView txtNama,txtJan,txtFeb,txtMar,txtApr,txtMei,txtJun,txtJul,txtAug,txtSep,txtOct,txtNov,txtDec;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_status_yuran_pengajar);
...
/*                    String nama= Objects.requireNonNull(dataSnapshot.child("nama").getValue()).toString();
                    String jan= Objects.requireNonNull(dataSnapshot.child("JanFee").getValue()).toString();*//*
                    ...
                    //Displaying status of fee of the month
