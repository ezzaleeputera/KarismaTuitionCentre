...
public class Sabtu_Activity_Pelajar_IbuBapa extends AppCompatActivity {

    Sabtu_Adapter_Pelajar_IbuBapa adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<Jadual_Model> options= new FirebaseRecyclerOptions
                ...
                .setQuery(FirebaseDatabase.getInstance().getReference()
                        .child("Jadual_Sabtu"),Jadual_Model.class).build();

        adapter= new Sabtu_Adapter_Pelajar_IbuBapa(options);
