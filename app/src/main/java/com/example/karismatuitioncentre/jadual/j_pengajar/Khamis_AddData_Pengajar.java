...
public class Khamis_AddData_Pengajar extends AppCompatActivity {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),
                        Khamis_Activity_Pengajar.class));
                finish();
            }
        });
    ...
    private void processinsert()
    {
        ...
        FirebaseDatabase.getInstance().getReference().child("Jadual_Khamis").push()
                .setValue(map)
