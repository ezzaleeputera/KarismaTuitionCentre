...
public class Jumaat_Adapter_Pelajar_IbuBapa extends FirebaseRecyclerAdapter<Jadual_Model,
        Jumaat_Adapter_Pelajar_IbuBapa.myviewholder>
{
    public Jumaat_Adapter_Pelajar_IbuBapa(@NonNull FirebaseRecyclerOptions<Jadual_Model> options) {
        super(options);
    }
