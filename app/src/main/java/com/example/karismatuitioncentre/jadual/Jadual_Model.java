...
{
    String subjek,pengajar,masaSHour,masaSMin,masaEHour,masaEMin;
    Jadual_Model()
    {

    }
    public Jadual_Model(String pengajar, String subjek, String masaSHour,String masaSMin,String masaEHour,String masaEMin) {
        this.subjek = subjek;
