...
public class Jumaat_Activity_Pengajar  extends AppCompatActivity {

    Jumaat_Adapter_Pengajar adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter= new Jumaat_Adapter_Pengajar(options);
