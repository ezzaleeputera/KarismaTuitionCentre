...
public class Ahad_Activity_Pelajar_IbuBapa extends AppCompatActivity {

    Ahad_Adapter_Pelajar_IbuBapa adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter= new Ahad_Adapter_Pelajar_IbuBapa(options);
