...
public class Khamis_Adapter_Pelajar_IbuBapa extends FirebaseRecyclerAdapter<Jadual_Model_Pengajar,
        Khamis_Adapter_Pelajar_IbuBapa.myviewholder>
{
    public Khamis_Adapter_Pelajar_IbuBapa(@NonNull FirebaseRecyclerOptions<Jadual_Model_Pengajar> options) {
        super(options);
    }
