...
public class Khamis_Adapter_Pelajar_IbuBapa extends FirebaseRecyclerAdapter<Jadual_Model,
        Khamis_Adapter_Pelajar_IbuBapa.myviewholder>
{
    public Khamis_Adapter_Pelajar_IbuBapa(@NonNull FirebaseRecyclerOptions<Jadual_Model> options) {
        super(options);
    }
