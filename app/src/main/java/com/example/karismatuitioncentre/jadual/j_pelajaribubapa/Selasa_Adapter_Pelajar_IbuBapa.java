...
public class Selasa_Adapter_Pelajar_IbuBapa extends FirebaseRecyclerAdapter<Jadual_Model,
        Selasa_Adapter_Pelajar_IbuBapa.myviewholder>
{
    public Selasa_Adapter_Pelajar_IbuBapa(@NonNull FirebaseRecyclerOptions<Jadual_Model> options) {
        super(options);
    }
