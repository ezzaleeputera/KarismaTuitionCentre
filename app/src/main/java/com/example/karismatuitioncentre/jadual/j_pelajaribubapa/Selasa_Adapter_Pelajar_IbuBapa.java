...
public class Selasa_Adapter_Pelajar_IbuBapa extends FirebaseRecyclerAdapter<Jadual_Model_Pengajar,
        Selasa_Adapter_Pelajar_IbuBapa.myviewholder>
{
    public Selasa_Adapter_Pelajar_IbuBapa(@NonNull FirebaseRecyclerOptions<Jadual_Model_Pengajar> options) {
        super(options);
    }
